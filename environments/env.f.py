...
app = Flask(__name__)
app.config['SERVER_NAME'] = 'env.f:5002'
lightIsOn1 = False
lightIsOn2 = False
pressCount1 = 0
pressCount2 = 0
...
@app.route("/")
def hello():
    return "This is 2 buttons and a lightbulb! One light toggles every two presses. The other light toggles every four presses."
...
def pushButton1():
    global lightIsOn1, pressCount1, lightIsOn2, pressCount2
    if pressCount1 == 1:
        pressCount1 = 0
