...
print("----")
b1 = Branch(iterModel.librarian, [1,0], hypotheses = [iterModel.tcmDict[chosenEnvInfo['infos'][0]].bestHypothesis])
b2 = Branch(iterModel.librarian, [1,0], branch = b1)
b3 = Branch(iterModel.librarian, [1,0], branch = b2)
b4 = Branch(iterModel.librarian, [1,0], branch = b3)
b5 = Branch(iterModel.librarian, [0,1], branch = b4)
b6 = Branch(iterModel.librarian, [0,0], branch = b5)
b7 = Branch(iterModel.librarian, [0,0], branch = b6)
b8 = Branch(iterModel.librarian, [1,1], branch = b7)
b9 = Branch(iterModel.librarian, [1,0], branch = b8)
b10 = Branch(iterModel.librarian, [1,0], branch = b9)
b11 = Branch(iterModel.librarian, [0,0], branch = b10)
b12 = Branch(iterModel.librarian, [0,0], branch = b11)
b13 = Branch(iterModel.librarian, [0,1], branch = b12)
b14 = Branch(iterModel.librarian, [1,0], branch = b13)
b15 = Branch(iterModel.librarian, [0,0], branch = b14)
b16 = Branch(iterModel.librarian, [1,0], branch = b15)
