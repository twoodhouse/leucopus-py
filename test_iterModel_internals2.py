...
b4 = Branch(iterModel.librarian, actions = [1, 1], branch = b3)
b5 = Branch(iterModel.librarian, actions = [1, 1], branch = b4)
b6 = Branch(iterModel.librarian, actions = [1, 1], branch = b5)
b7 = Branch(iterModel.librarian, actions = [1, 1], branch = b6)
b8 = Branch(iterModel.librarian, actions = [1, 1], branch = b7)
