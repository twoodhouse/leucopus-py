...
b2 = Branch(iterModel.librarian, actions = [0, 0], branch = b1)
b3 = Branch(iterModel.librarian, actions = [0, 0], branch = b2)
b4 = Branch(iterModel.librarian, actions = [0, 0], branch = b3)
b5 = Branch(iterModel.librarian, actions = [0, 0], branch = b4)
b6 = Branch(iterModel.librarian, actions = [1, 0], branch = b5)
b7 = Branch(iterModel.librarian, actions = [1, 0], branch = b6)
b8 = Branch(iterModel.librarian, actions = [1, 0], branch = b7)
b9 = Branch(iterModel.librarian, actions = [1, 1], branch = b8)
b10 = Branch(iterModel.librarian, actions = [1, 1], branch = b9)
b11 = Branch(iterModel.librarian, actions = [1, 1], branch = b10)
b12 = Branch(iterModel.librarian, actions = [1, 1], branch = b11)
b13 = Branch(iterModel.librarian, actions = [1, 1], branch = b12)
b14 = Branch(iterModel.librarian, actions = [1, 1], branch = b13)
b15 = Branch(iterModel.librarian, actions = [1, 1], branch = b14)
b16 = Branch(iterModel.librarian, actions = [1, 1], branch = b15)
